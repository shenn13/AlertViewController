...
- (instancetype)initWithTitle:(NSString *)title button1:(NSString *)button1 button2:(NSString *)button2 cancleBtn:(NSString *)cancleBtn{
    ...
    if (self == [super init]) {
        ...
        if (button1) {
            ...
            self.button1.frame = CGRectMake((LAVWIDTH - 150)/2, CGRectGetMaxY(self.titleLabel.frame) + LAVSPACE, 150, 40);
            self.button1.backgroundColor = RGBa(86, 192, 77, 1);
        ...
        if (button2) {
            ...
            self.button2.frame = CGRectMake((LAVWIDTH - 150)/2, CGRectGetMaxY(self.button1.frame) + LAVSPACE, 150, 40);
            self.button2.backgroundColor = RGBa(86, 192, 77, 1);
        ...
        if(cancleBtn){
            ...
            self.cancleBtn.frame = CGRectMake((LAVWIDTH - 150)/2, CGRectGetMaxY(self.button2.frame) + LAVSPACE, 150, 40);
